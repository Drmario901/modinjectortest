...
camo_list = ["None", "DEVGRU", "A-TACS-AU", "ERDL", "Siberia", "Choco", "Tigre", "Gouttes", "Ghostex : Delta 6"
			, "Kryptek : Typhon", "Fibra de carbono", "Fleurs", "El arte de la guerra", "Ronin", "Huesos"
			, "Oro", "Diamante", "Money", "Bacon", "Vipere", "Zombie", "Party Rock", "Kawaii", "La deuda de los muertos"
...
cc_list = ["None", "The Deuce", "Nuketown Zombies", "Nuketown 2025", "Dragon Fire", "Elite Founder", "Elite Member", "Peacekeeper", "Kawaii", "Jungle Warfare", "[!CRASH!]", "Benjamin", "Dead", "Grafity", "Party Rock", "Zombie", "Viper", "Bacon", "Canada", "USA", "Egypt", "Belgi", "England", "France", "Germany", "Italy", "Spain", "Switerland", "England", "Australia", "Bangladesh", "Jerusalem", "Japan"]
...
ss_list = ["None", "Drone", "RC-XD", "Haunt drone", "strat.", "Drone", "Gar"
			,"Missile", "ment", "auto.", "War Machine", "War", "Dragonfire"
			,"Robot", "Aeronef fur.", "Microstation orb.", "Drone descortes", "IEM", "Warthog"
			,"Lodestar", "ADAV", "K9", "Group"]
...
def connect():
		...
		change_text("^2Connected to DrMario90 Mod Injector")
...
root = Tk()
root.title("Black Ops 2 Mod Menu Injector by DrMario90")
note = Notebook(root)
